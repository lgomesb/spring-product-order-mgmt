...
public class ProductOrderMgmtAspect {
    ...
    @Before("execution(* com.barbosa.ms.productordermgmt.product-order-mgmt.services.*.* (..))")
    ...
    @AfterReturning(pointcut = "execution(* com.barbosa.ms.productordermgmt.product-order-mgmt.services.*.* (..))", returning = "result")
