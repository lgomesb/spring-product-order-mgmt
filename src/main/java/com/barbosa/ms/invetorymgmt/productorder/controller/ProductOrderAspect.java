...
@Aspect
@Component
public class ProductOrderAspect {
    
        private final Logger logger = LoggerFactory.getLogger(this.getClass());

    @Before("execution(* com.barbosa.ms.invetorymgmt.productorder.services.*.* (..))")
    ...
    @AfterReturning(pointcut = "execution(* com.barbosa.ms.invetorymgmt.productorder.services.*.* (..))", returning = "result")
